...
function Home3() {
  return (
  <div class="Styledhome3">
      <h2 class="headertekst">UPCOMING EVENTS</h2>
      <div class="wrapper">
        <div class="image">
        ...
        <div class="text-box">
          <h3>Event 1 Name</h3>
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Enim neque a omnis veniam ducimus possimus cumque earum inventore incidunt fugit doloribus quibusdam delectus quos quasi temporibus culpa, et, ab consequuntur.
